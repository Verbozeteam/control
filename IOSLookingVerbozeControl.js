...
import PagingView from './ioslookingcomponents/PagingView';
...
class IOSLookingVerbozeControl extends React.Component<{}, StateType> {
...
IOSLookingVerbozeControl.contextTypes = {
...
IOSLookingVerbozeControl = connect(mapStateToProps, mapDispatchToProps) (IOSLookingVerbozeControl);
...
class IOSLookingVerbozeControlWrap extends React.Component<any> {
    render() {
        return <Provider store={STORE}><IOSLookingVerbozeControl /></Provider>
    }
}

module.exports = IOSLookingVerbozeControlWrap;
