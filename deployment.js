...
if (default_ssid === ("{{SS" + "ID}}")) default_ssid = "";
if (default_passphrase === ("{{PASS" + "WORD}}")) default_passphrase = "";
if (default_ip === ("{{TARGE" + "T_IP}}")) default_ip = "192.168.10.1";
if (default_port === ("{{TARGET" + "_PORT}}")) default_port = 7990;
