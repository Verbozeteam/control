            ...
            case 'modern':
                ...
                roomTemperatureView = (
                    <View style={tabStyles.roomTempContainer}>
                        <Text style={[tabStyles.roomTempText, {fontSize: 40}]}>{temp ? temp.toFixed(1) + " °C" : "22.0 °C" }</Text>
                    ...
                    <View style={tabStyles.settingsContainer}>
                        <View style={tabStyles.settingTemp}>
                            ...
                            <View style={tabStyles.settingTempButtonsContainer}>
                                ...
                                <Text style={tabStyles.settingTempText}>{(fan == 0) ? I18n.t('Off') : (set_pt ? set_pt.toFixed(1) + " °C" : "22.0 °C" ) }</Text>
                                <TouchableWithoutFeedback
                        ...
                        <View style={[tabStyles.settingFanContainer, {width: (fan_speeds.length+1)*90}]}>
                            {['Off'].concat(fan_speeds).map((fs, i) =>
                                <MagicButton
                                    ...
                                    textColor={displayConfig.acTextColor}
            ...
            case 'simple':
                ...
                var fan_speed_boxes = fan_speeds.map((fs, i) =>
                    <TouchableWithoutFeedback key={"fan-speed-"+i} onPressIn={() => this.changeFan(i+1)}>
                        <View style={simpleStyles.fan_speed_container}>
                            ...
                            <Text style={[simpleStyles.fan_speed_text, {color: displayConfig.acTextColor}]}>{I18n.t(fs)}</Text>
                        </View>
                    </TouchableWithoutFeedback>
                );
                ...
                var toggles = (
                    <View style={simpleStyles.fan_controls_container}>
                        <Text style={[simpleStyles.fan_speed_text, {fontSize: 30, flex: 1, color: displayConfig.acTextColor}]}>{I18n.t('Fan')}</Text>
                        {fan_speed_boxes}
                    </View>
                );
                ...
                var onoffButton = (
                    <TouchableWithoutFeedback onPressIn={() => this.changeFan(fan === 0 ? 1 : 0)}>
                        <View style={simpleStyles.button_container}>
                            <Text style={[simpleStyles.fan_speed_text, {fontSize: 30, height: 68, paddingTop: 5, color: displayConfig.acTextColor}]}>{I18n.t(fan === 0 ? 'Off' : 'On')}</Text>
                    ...
                    <View style={simpleStyles.container}>
                        <View style={simpleStyles.temperature_container}>
                            ...
                            <View style={simpleStyles.center_text_container}>
                                ...
                                <Text style={[simpleStyles.center_text_sub, {color: displayConfig.acTextColor}]}>{center_text_sub}</Text>
                            </View>
                        </View>
