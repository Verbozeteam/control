...
export class ACSlider extends React.Component<PropsType, StateType> {
    static defaultProps = {
        enabled: true,
    ...
    render() {
        ...
        for (var i = 0; i < this._numDashes; i++) {
            ...
            lines.push(<Line key={"svg-line-"+i} x1={x} y1={height*(1/3)} x2={x} y2={height} stroke={color} strokeWidth={2} />);
        }
        ...
        return (
            <View style={{width, height}}
                ...
                <View style={{position: 'relative', width, height: height*(2/3), marginBottom: -height*(1/3)}}>
